...
<nav
	class="container fixed top-0 left-[50%] z-10 mx-auto flex w-full -translate-x-[50%] pr-6 pl-2 pt-4 text-neutral-content md:px-8">
	<!-- LOGO -->
...
<div
	...
	<img src={CITY_PHOTO} alt="" class="h-full w-full object-cover " />
</div>
