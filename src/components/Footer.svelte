...
<footer
	class="my-8 mx-4 flex flex-col items-center justify-between rounded-lg bg-neutral p-4 text-neutral-content sm:flex-row md:mt-0 lg:mx-auto lg:w-fit">
	<div class="flex items-center">
		...
		<p class="ml-4 mr-8 tracking-wide">Alejadro Sáez © 2022 v1.0</p>
	</div>
	<div class="flex">
		<a
